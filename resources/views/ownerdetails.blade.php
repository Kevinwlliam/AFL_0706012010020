        ...
        <div class="row gutters-sm">
            ...
            <div class="card">
              <div class="card-body">
                <div class="d-flex flex-column align-items-center text-center">
                  <img src="https://bootdey.com/img/Content/avatar/avatar7.png" alt="Admin" class="rounded-circle" width="165">
                  <div class="mt-3">
                    <h4 class="kev">{{ $owner['fullname'] }}</h4>
          ...
          <div class="col-md-8">
            <div class="kev card mb-3">
              <div class="card-body">
                  <div class="col-sm-3">
                    <h6 class="kev mb-0">Full Name: {{ $owner['fullname'] }}</h6>
                  </div>
                <hr>
                  <div class="col-sm-3">
                    <h6 class="kev mb-0">Contact Person: {{ $owner['contactperson'] }} </h6>
                  </div>
                <hr>
                  <div class="kev col-sm-3">
                    <h6 class="mb-0">Age: {{ $owner['age'] }}</h6>
                  </div>
                <hr>
                  <div class="kev col-sm-3">
                    <h6 class="mb-0">Gender : {{ $owner['gender'] }}</h6>
                  </div>
                <hr>
                  <div class="kev col-sm-3">
                    <h6 class="mb-0">Business Personality: {{ $owner['description'] }}</h6>
                  </div>
                <hr>
                  <div class="col-sm-12">
                    <a class="btn btn-info " href="{{ route('ownerlist.edit', $owner['owner_code']) }}">Edit</a>
                  </div>
              </div>
            </div>
          </div>
